...
class modsearcheverywhere extends DolibarrModules
{
    ...
    public function __construct($db)
    {
        ...
        $this->module_parts = array(
            ...
            //'css' => '/searcheverywhere/css/mycss.css.php',
        ...
        $this->tabs = array(
            ...
            //	'objecttype:+tabname1:Title1:langfile@searcheverywhere:$user->rights->searcheverywhere->read:/searcheverywhere/mynewtab1.php?id=__ID__',
            //	// To add another new tab identified by code tabname2
            //	'objecttype:+tabname2:Title2:langfile@searcheverywhere:$user->rights->othermodule->read:/searcheverywhere/mynewtab2.php?id=__ID__',
        ...
        // Dictionnaries
        if (! isset($conf->searcheverywhere->enabled)) {
