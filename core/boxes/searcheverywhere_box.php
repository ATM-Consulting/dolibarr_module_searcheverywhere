 ...
 */
class searcheverywherebox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "searcheverywhere@searcheverywhere";
    public $boxlabel;
    public $depends = array("searcheverywhere");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/searcheverywhere/class/searcheverywhere.class.php";
